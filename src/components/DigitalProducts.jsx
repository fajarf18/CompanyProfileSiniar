...
const DigitalProducts = () => {
    ...
    const products = [
        ...
        },
        {
            ...
            price: 'Rp 350.000',
            description:
                'Koleksi template design untuk social media (Instagram, Facebook, Twitter). Lebih dari 100 template siap edit untuk berbagai kebutuhan.',
            features: [
                '100+ template premium',
                'Format Canva & Figma',
                'Semua ukuran social media',
                'Easy to customize',
                'Commercial license',
